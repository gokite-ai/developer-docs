...
Ask your agent to create a Kite Passport account. You will receive a verification email — click the link, and it will take you directly to the Passport dashboard.
...
You only need to create a passkey once per device. After this step, the agent automatically logs in and is ready to go.
...
- **Request test tokens** if you are on testnet — available from the dashboard or via the agent
...
- *"Call this API endpoint: https://example.com/api/service"*
