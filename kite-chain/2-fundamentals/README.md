...
- **[Blockchain Basics](blockchain-fundamentals.md)** - Understanding distributed ledgers, consensus, and blockchain architecture
- **[Smart Contract Basics](smart-contract-basics.md)** - How programmable logic works on blockchains and key concepts
...
1. Move to [Developing Smart Contracts](../3-developing/README.md) to write your first contract
2. Build complete [dApps](../4-building-dapps/README.md) with user interfaces
3. Explore [Advanced Features](../5-advanced/README.md) like account abstraction

---

*Already familiar with blockchain? Skip to [Developing on Kite](../3-developing/README.md)!*
