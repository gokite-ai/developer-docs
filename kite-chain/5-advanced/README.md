...
- **[Account Abstraction SDK](account-abstraction-sdk.md)** - Simplify user onboarding with gasless transactions and smart accounts
- **[Multisig Wallet](multisig-wallet.md)** - Secure multi-signature wallet implementation for team asset management
...
- Complete [Smart Contract Development](../3-developing/README.md)
- Build at least one [dApp](../4-building-dapps/README.md)
...
- Check [Governance](../6-reference/governance.md) for protocol updates
- Explore [Reference Documentation](../6-reference/README.md) for operational details

---

*These are advanced topics. Make sure you're comfortable with [basic development](../3-developing/README.md) first!*
