...
- **[Counter dApp](counter-dapp.md)** - Simple counter interface with wallet connection
- **[Voting dApp](voting-dapp.md)** - Decentralized voting system with real-time results
- **[Token Minter](token-minter.md)** - Create and manage custom tokens
...
- Counter dApp: [https://kite-counter-dapp.vercel.app/](https://kite-counter-dapp.vercel.app/)

All source code is available on GitHub for you to fork and modify.

## Development Workflow

1. **Deploy Smart Contracts** - Use contracts from the [Developing](../3-developing/README.md) section
...
- Complete the [Smart Contract Development](../3-developing/README.md) tutorials
...
- Explore [Advanced Features](../5-advanced/README.md) like Account Abstraction and Multisig
- Review [Security Best Practices](../6-reference/security.md)
- Deploy to production and check [Node Operations](../6-reference/node-operators.md)

---

*Need to deploy contracts first? Check out [Developing Smart Contracts](../3-developing/README.md)!*
